...
let MaterialtrainingComponent = class MaterialtrainingComponent {
    constructor() {
        this.isCheck = true;
...
let ProjectComponentComponent = class ProjectComponentComponent {
    constructor() { }
    ngOnInit() {
    }
};
...
let SidebarComponentComponent = class SidebarComponentComponent {
    constructor() { }
    ngOnInit() {
    }
};
